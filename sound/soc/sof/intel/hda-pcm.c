...
EXPORT_SYMBOL_NS(hda_dsp_compress_hw_params, "SND_SOC_SOF_INTEL_HDA_COMMON");
...
EXPORT_SYMBOL_NS(hda_dsp_compress_trigger, "SND_SOC_SOF_INTEL_HDA_COMMON");
...
EXPORT_SYMBOL_NS(hda_dsp_compress_pointer, "SND_SOC_SOF_INTEL_HDA_COMMON");
...
EXPORT_SYMBOL_NS(hda_dsp_compress_open, "SND_SOC_SOF_INTEL_HDA_COMMON");
...
int hda_dsp_compress_close(struct snd_sof_dev *sdev, struct snd_compr_stream *cstream)
{
	struct hdac_stream *hstream = cstream->runtime->private_data;
	int direction = cstream->direction;
	int ret;
...
EXPORT_SYMBOL_NS(hda_dsp_compress_close, "SND_SOC_SOF_INTEL_HDA_COMMON");
