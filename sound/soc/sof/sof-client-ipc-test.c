...
MODULE_DEVICE_TABLE(auxiliary, sof_ipc_test_client_id_table);
 ...
 */
static struct auxiliary_driver sof_ipc_test_client_drv = {
	.probe = sof_ipc_test_probe,
	.remove = sof_ipc_test_remove,

	.id_table = sof_ipc_test_client_id_table,
};

module_auxiliary_driver(sof_ipc_test_client_drv);
